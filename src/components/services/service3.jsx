    ...
    <section className="bg-black text-white py-24 px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 grid sm:grid-cols-2 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
        ...
        {[
          ...
          <motion.div
            ...
            className="bg-[#111] border border-yellow-500/10 hover:border-yellow-500 rounded-2xl p-6 text-center transition shadow-lg"
          >
            <h3 className="text-xl font-semibold group-hover:text-yellow-400">
              {item}
            </h3>
          </motion.div>
        ))}
      ...
      <div className="relative z-10 mt-20 max-w-5xl mx-auto text-center">
        ...
        <h3 className="text-3xl md:text-4xl font-bold mb-6">
          Why Clients <span className="text-yellow-400">Trust Us?</span>
        </h3>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-12">
          ...
          <div className="bg-[#111] p-6 rounded-xl border border-yellow-500/10 hover:border-yellow-500 transition">
            <h4 className="text-xl font-bold text-yellow-400 mb-2">100% Satisfaction</h4>
          ...
          <div className="bg-[#111] p-6 rounded-xl border border-yellow-500/10 hover:border-yellow-500 transition">
            <h4 className="text-xl font-bold text-yellow-400 mb-2">Creative Designs</h4>
            <p className="text-gray-400 text-sm">
          ...
          <div className="bg-[#111] p-6 rounded-xl border border-yellow-500/10 hover:border-yellow-500 transition">
            <h4 className="text-xl font-bold text-yellow-400 mb-2">On-Time Setup</h4>
            <p className="text-gray-400 text-sm">
